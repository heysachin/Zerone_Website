...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Matrox is a responsive creative agency template">
        <meta name="keywords" content="material, corporate, business, parallax, creative, agency">
        <meta name="author" content="trendytheme.net">

        <title>Matrox Corporate</title>
                    ...
                    <div id="matrox-menu" class="menuzord">
                        ...
                        <ul class="menuzord-menu pull-right">
                            ...
                            <li class="active"><a href="javascript:void(0)">Portfolio</a>
                                <ul class="dropdown">
                                    <li class="active"><a href="corporate-portfolio-4.html">Portfolio 4 Column</a></li>
                                    <li><a href="corporate-portfolio-3.html">Portfolio 3 Column</a></li>
                                    <li><a href="corporate-portfolio-2.html">Portfolio 2 Column</a></li>
                      ...
                      <div class="portfolio-item" data-groups='["all", "marketing", "websites"]'> 
                          <div class="portfolio-wrapper">
                            ...
                            <div class="thumb">
                                ...
                                <div class="portfolio-intro">
                                  <div class="action-btn">
                                    <a href="assets/img/portfolio/portfolio-2.jpg" class="tt-lightbox" title="iOS Game Design"> <i class="fa fa-search"></i></a>
                                  </div>
                                </div>
                            </div><!-- thumb -->
                      ...
                      <div class="portfolio-item" data-groups='["all", "photography", "branding"]'>
                          <div class="portfolio-wrapper">
                            ...
                            <div class="thumb">
                                ...
                                <div class="portfolio-intro">
                                  <div class="action-btn">
                                    <a href="assets/img/portfolio/portfolio-3.jpg" class="tt-lightbox" title="iOS Game Design"> <i class="fa fa-search"></i></a>
                                  </div>
                                </div>
                            </div><!-- thumb -->
                      ...
                      <div class="portfolio-item" data-groups='["all", "websites", "branding"]'>
                          <div class="portfolio-wrapper">
                            ...
                            <div class="thumb">
                                ...
                                <div class="portfolio-intro">
                                  <div class="action-btn">
                                    <a href="assets/img/portfolio/portfolio-4.jpg" class="tt-lightbox" title="iOS Game Design"> <i class="fa fa-search"></i></a>
                                  </div>
                                </div>
                            </div><!-- thumb -->
                      ...
                      <div class="portfolio-item" data-groups='["all", "photography", "marketing"]'>
                          ...
                          <div class="portfolio-wrapper">
                            ...
                            <div class="thumb">
                                ...
                                <div class="portfolio-intro">
                                  <div class="action-btn">
                                    <a href="assets/img/portfolio/portfolio-5.jpg" class="tt-lightbox" title="iOS Game Design"> <i class="fa fa-search"></i></a>
                                  </div>
                                </div>
                            </div><!-- thumb -->

                            <div class="portfolio-title">
                                <h2><a href="#">Interface Design</a></h2>
                                <p><a href="#">iOS Design</a> </p>
                            </div>
                          </div><!-- /.portfolio-wrapper -->
                      </div><!-- /.portfolio-item -->
                      ...
                      <div class="portfolio-item" data-groups='["all", "websites",  "marketing"]'>
                        <div class="portfolio-wrapper">
                          <div class="thumb">
                              ...
                              <div class="portfolio-intro">
                                <div class="action-btn">
                                    <a href="assets/img/portfolio/portfolio-6.jpg" class="tt-lightbox" title=""> <i class="fa fa-search"></i></a>
                                </div>
                              </div>
                          </div>
                          <div class="portfolio-title">
                      ...
                      <div class="portfolio-item" data-groups='["all", "websites", "photography"]'>
                          <div class="portfolio-wrapper">
                            ...
                            <div class="thumb">
                                ...
                                <div class="portfolio-intro">
                                  <div class="action-btn">
                                    <a href="assets/img/portfolio/portfolio-7.jpg" class="tt-lightbox" title="iOS Game Design"> <i class="fa fa-search"></i></a>
                                  </div>
                                </div>
                            </div><!-- thumb -->

                            <div class="portfolio-title">
                                <h2><a href="#">Dashboard Design</a></h2>
                                <p><a href="#">iOS Design</a> </p>
                            </div>
                      ...
                      <div class="portfolio-item" data-groups='["all", "branding", "marketing"]'>
                          <div class="portfolio-wrapper">
                            ...
                            <div class="thumb">
                                ...
                                <div class="portfolio-intro">
                                  <div class="action-btn">
                                    <a href="assets/img/portfolio/portfolio-8.jpg" class="tt-lightbox" title="iOS Game Design"> <i class="fa fa-search"></i></a>
                                  </div>
                                </div>
                            </div><!-- thumb -->
